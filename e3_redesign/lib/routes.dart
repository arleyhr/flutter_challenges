...
import 'package:e3_redesign/screens/detail.dart';
import 'package:e3_redesign/screens/home.dart';
...
class E3RedesignRoutes {
  ...
  var _detailHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    return E3RedesignDetail(gameId: params['gameId']?.first);
  });


  E3RedesignRoutes(Router router) {
