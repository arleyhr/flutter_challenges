          ...
          body: CustomScrollView(
            slivers: <Widget>[
              SliverPersistentHeader(
                pinned: true,
                delegate: TravelAppDetailHeader(
                    image: travelAppPlaces[int.parse(placeId!)],
                    placeId: placeId),
              ),
              SliverList(
                                        ...
                                        RichText(
                                          text: TextSpan(children: [
                                            TextSpan(
                                                ...
                                                style: TextStyle(
                                                    color:
                                                        travelAppColors["gray"],
                                                    fontSize: 12)),
                                            TextSpan(
                                                text: "( 450 Reviews )",
                                                style: TextStyle(
                                                    color: travelAppColors[
                                                        "lightgray"],
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                      text:
                                          'Lorem ipsum dolor sit ame t, consectetur sed do eiusmod tempor incididuntgfgnt.Lorem ipsum is placeholder text commonly used inu the graphic, print, and publishing industries foruu previewing layouts and visual mockups...   ',
                                      style: TextStyle(
                                  ...
                                  TextSpan(
                                      text: "Read more",
                                      style:
                                          TextStyle(color: Color(0xFF14C8CC)))
                                ]),
                          ),
                        ),
                        SizedBox(height: 30),
