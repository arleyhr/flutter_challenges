...
const popcorn =
    "https://res.cloudinary.com/arleyhr/image/upload/v1578169554/flutter/ticket-reservation-interaction/popcorn_iqpsty.png";
const corn =
    "https://res.cloudinary.com/arleyhr/image/upload/v1578065175/flutter/ticket-reservation-interaction/corn_oyow5w.png";
...
class TicketReservationInteraction extends StatefulWidget {
  ...
  @override
  _TicketReservationInteractionState createState() =>
      _TicketReservationInteractionState();
}

class _TicketReservationInteractionState
    extends State<TicketReservationInteraction> {
  ...
  void _handleAnimation(itemNumber) {
    final newPosition = (itemNumber * _selectionPositionWidth) +
        (itemNumber * _selectionPositionMargin);
    setState(() {
            ...
            children: <Widget>[
                  ...
                  Positioned(
                      ...
                      child: AnimatedContainer(
                          ...
                          child: AnimatedOpacity(
                              ...
                              child:
                                  Image.network(popcorn, fit: BoxFit.cover)))),
                  Positioned(
                      right: 25,
                      bottom: 10,
                      child: AnimatedContainer(
                ...
                child: Container(
                  ...
                  child: Stack(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                          children:
                              List<Widget>.generate(_numberOfButtons, (i) {
                        final lastIndex = _numberOfButtons - 1;
                        return Container(
                          margin: EdgeInsets.only(
                              right: i != lastIndex
                                  ? _selectionPositionMargin
                                  : 0),
                          width: _selectionPositionWidth,
                          height: 40,
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  primary: redColor,
                  minimumSize:
                      Size(MediaQuery.of(context).size.width * 0.65, 42),
                ),
                onPressed: () {},
