...
import '../widgets/games_swiper.dart';
    ...
    return SliverList(
      ...
      Container(
        ...
        child: Slider(
          ...
          onChanged: onSliderChange as void Function(double)?,
        ),
      )
    ]));
  }
...
class RightStats extends StatelessWidget {
  RightStats({Key? key, this.selectedGame}) : super(key: key);
    ...
    return Positioned(
      ...
      child: Column(
        children: <Widget>[
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.bubble_chart, size: 35, color: primaryColor),
          ),
          Text('${selectedGame!.percent}%',
              style: TextStyle(
                  fontSize: 18,
                  height: 0.5,
                  color: Colors.grey,
          ...
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.people, size: 35, color: primaryColor),
          ),
          Text(selectedGame!.people.toString(),
              style: TextStyle(
                  height: 0.5,
                  fontSize: 18,
                  color: Colors.grey,
          ...
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.favorite_border, size: 35, color: primaryColor),
          )
        ],
      ),
    );
