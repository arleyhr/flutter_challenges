...
import '../widgets/console_detail_sliver_appbar.dart';
import '../widgets/swiper_view.dart';
...
class AppForCollectorsConsole extends StatefulWidget {
  ...
  @override
  _AppForCollectorsConsoleState createState() =>
      _AppForCollectorsConsoleState(consoleId: this.consoleId);
}
...
class _AppForCollectorsConsoleState extends State<AppForCollectorsConsole> {
  ...
  void didChangeDependencies() {
    ...
    List<Game> gamesList =
        games.where((game) => game.consoleId.toString() == consoleId).toList();
  ...
  Widget build(BuildContext context) {
    ...
    _onGameTap(gameId) {
      Application.router!.navigateTo(
          context, AppForCollectorsRoutes.getGamePath(gameId: gameId));
    }
