            ...
            GameCard(
                ...
                onPress: () {
                  Application.router!.navigateTo(
                      context, E3RedesignRoutes.getDetailPath(gameId: 'gears'));
                }),
            SizedBox(height: 30),
            GameCard(
              ...
              onPress: () {
                Application.router!.navigateTo(context,
                    E3RedesignRoutes.getDetailPath(gameId: 'cyberpunk'));
              },
            ),
            SizedBox(height: 30),
            Row(children: <Widget>[
              ...
              Container(
                  ...
                  child: RawMaterialButton(
                    ...
                    child: Image.network(e3RedesignImages["favorite_comment"]!,
                        width: 18),
                  )),
            ]),
            SizedBox(height: 30)
