...
final String plusImage =
    '$imagePrefix/v1617841809/flutter/restaurant_details_review/plus_bjnsov.png';
final String dinnerImage =
    '$imagePrefix/v1617841803/flutter/restaurant_details_review/dinner_qsuuj4.png';

class RestaurantDetailsReview extends StatefulWidget {
  RestaurantDetailsReview({Key? key}) : super(key: key);

  _RestaurantDetailsReviewState createState() =>
      _RestaurantDetailsReviewState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[Icon(Icons.search, size: 30), SizedBox(width: 10.0)],
        title: Text('Food Details Review',
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 5),
              Text('48 Avenue Marceau, 75008 PARIS',
      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
                border: Border(bottom: BorderSide(width: 2, color: mainColor))),
            child: Text('Menu',
                style:
          ...
          Container(
            ...
            child: Text('Reviews (951)',
                style: TextStyle(fontWeight: FontWeight.w600)),
          ),
          Container(
            child:
                Text('Informations', style: TextStyle(color: lightGreyColor)),
          ),
        ],
      ),
    );
        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
                color: Colors.white,
                border: Border.all(
                    color: isSelected ? mainColor : lightGreyColor, width: 2),
                borderRadius: BorderRadius.circular(10),
